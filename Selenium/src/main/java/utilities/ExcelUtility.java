...
public class ExcelUtility {
	...
	public static String getStringData(int a,int b, String sheet) throws IOException
	{
		// row a& b cell values in excel 
			...
			f=new FileInputStream("C:\\Users\\user\\git\\Automation\\Selenium\\src\\test\\resources\\Testing data.xlsx");
		...
		/*public static String getFloatData(int a,int b,String sheet) throws IOException
		{
			...
			XSSFRow r=sh.getRow(a);
			XSSFCell c=r.getCell(b);
			float x=(float) c.getNumericCellValue();//get the numeric cell value
